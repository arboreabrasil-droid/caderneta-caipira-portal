...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    // Aqui você adicionará a lógica de autenticação depois
  };
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-amber-100 to-green-100 relative overflow-hidden">
        <div 
        ...
        <div className="relative z-10 p-12 flex flex-col justify-between text-white">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-semibold">CAIPIRA DA CIDADE</span>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            <h1 className="text-3xl font-bold text-gray-900">Caderneta Caipira</h1>
            <p className="text-gray-600 mt-2">Portal de Gestão Rural</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-gray-500">OU COM E-MAIL</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-green-700 hover:bg-green-800 text-white font-semibold py-3 px-4 rounded-lg transition-colors shadow-sm"
            >
              Entrar
            </button>
          </form>
